...
// Spotify's Dev Mode allowlist hard-caps at 5 emails total; 1 is permanently
// reserved for the admin/dev account (SONARAEM_SPOTIFY_ALLOWLIST_ADMIN_EMAIL),
// leaving this many real-user seats (#392).
