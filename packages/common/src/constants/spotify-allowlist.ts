...
// Spotify's Dev Mode allowlist hard-caps at 5 emails total; 1 is permanently reserved for the admin/dev account (SONARAEM_SPOTIFY_ALLOWLIST_ADMIN_EMAIL). This many seats rotate (docs/decisions/0001) — the count that matters is how many are concurrently `on_list`, not how many rows have ever existed.
